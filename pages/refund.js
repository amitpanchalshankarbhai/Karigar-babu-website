                ...
                <>
                    ...
                    <section style={{ marginBottom: '150px', padding: '200px' }} id="contact-us" className="about-area pt-70">
                        <>
                            ...
                            <p>Thank you for shopping at Karigar Babu.</p>
                            <p>
                            ...
                            <ul>
                                <li>
                                    <p>
                                        ...
                                        "Us" or "Our" in this Agreement) refers to SOVERIGNBRAIN PRIVATE
                                        LIMITED, A-104, Jay bhanu society, Ghatlodiya, Ahemdabad-380061,
                                        Gujrat..
                                    </p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <p>
                                        <strong>Website</strong> refers to Karigar Babu, accessible from{" "}
                                        <a
                                            href="https://karigarbabu.com/"
                                            rel="external nofollow noopener"
                                            target="_blank"
                                        >
                                            https://karigarbabu.com/
                                        </a>
                                    </p>
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>By email: karigar.babu.4@gmail.com</li>
                            </ul>
                            <p>
